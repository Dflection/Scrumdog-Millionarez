...
class Database:
    ...
    def averages(self, days)-> None:
        ...
        for item in numbies:   
            # This variable is = to the existing "entry"(item) in final_numbies is the sign value is already in final_numbies
        ...
        # This takes the items in final numbies and averages out the seconds from the total each sign was seen by dividing the total seconds by the number of students
